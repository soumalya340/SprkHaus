...
contract Poap is Ownable, ERC721Enumerable {
    ...
    constructor(
        string memory poapName,
        string memory poapSymbol
    ) ERC721(poapName, poapSymbol) Ownable() {}
    ...
    function confirmMetIRL(
        ...
        if (metIRLMapping[partyA] == partyB) {
            ...
            emit PoapMinted(currentTokenID, partyA, partyB, attestationId);

            return (attestationId, currentTokenID);
        } else {
